...
public class CubicLineChartManger {
    private LineChart chart;

    public CubicLineChartManger(LineChart chart){
        this.chart = chart;
        setChart();
    }
    ...
    private void setChart(){
        ...
        //设置y轴字体颜色
        y.setTextColor(Color.parseColor("#FFBDCADB"));
        //y标签相对于图表位置的枚举
    ...
    public void setData(List<QNHeartRateItem> mList){
        ...
        initLineDataSet(lineDataSet,Color.parseColor("#FFEC4385"),LineDataSet.Mode.CUBIC_BEZIER);
