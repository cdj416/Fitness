...
public class SmartLineChartManager {

    private List<SmartHistoricalUseData> mList;
    private LineChart chart;

    public SmartLineChartManager(LineChart chart,List<SmartHistoricalUseData> mList){
        this.chart = chart;
        this.mList = mList;
        setChart();
    }
    ...
    * 设置显示值
    * */
    public void setData(List<SmartHistoricalUseData> mList){
        ArrayList<Entry> values = new ArrayList<>();

        for (int i = 0; i < mList.size(); i++) {
            values.add(new Entry(i, Float.valueOf(mList.get(i).getShowText())));
        }
