...
public class StoreMyCouponFragment extends CustomFragment {
    ...
    public void initView(View mView) {
        ...
        meunAdapter = new MyCouponPagerAdapter(getChildFragmentManager(),MyCouponPagerAdapter.STORE_COUPON);
