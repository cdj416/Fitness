...
public class EncyclopediaPopularFragment extends CustomFragment {
    ...
    * */
    private void getList(){
        ...
        Controller.myRequest(Constants.GET_ARTICLE_LIST_RM,Controller.TYPE_POST,getParams(), EncyclopediaBean.class,this);
    }
