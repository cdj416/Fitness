package com.hongyuan.fitness.ui.out_door.wallk.my_top_view;
...
public class TopTab extends BaseTabItem {
    ...
    public TopTab(@NonNull Context context) {
        this(context, null);
    }

    public TopTab(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TopTab(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        LayoutInflater.from(context).inflate(R.layout.view_outdoor_top_tab, this, true);
