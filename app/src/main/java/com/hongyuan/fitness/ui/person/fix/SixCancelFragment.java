...
public class SixCancelFragment extends CustomFragment {

    private RecyclerView mRec;
    private SixCancelCourseAdapter adapter;
    ...
    public void initView(View mView) {
        ...
        adapter = new SixCancelCourseAdapter();
    ...
    protected void lazyLoad() {
        ...
        clearParams().setParams("state_str","5");
