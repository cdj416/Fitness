...
public class Heat01Adapter extends BaseQuickAdapter<HeatBean.DataBean.ListBeanXXXXXX._$1Bean.ListBean, BaseViewHolder> {

    public Heat01Adapter() {
        super(R.layout.item_heat_child);
    }

    @Override
    protected void convert(BaseViewHolder helper, HeatBean.DataBean.ListBeanXXXXXX._$1Bean.ListBean item) {
