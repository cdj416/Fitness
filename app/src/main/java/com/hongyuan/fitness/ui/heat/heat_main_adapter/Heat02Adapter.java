...
public class Heat02Adapter extends BaseQuickAdapter<HeatBean.DataBean.ListBeanXXXXXX._$2Bean.ListBeanX, BaseViewHolder> {

    public Heat02Adapter() {
        super(R.layout.item_heat_child);
    }

    @Override
    protected void convert(BaseViewHolder helper, HeatBean.DataBean.ListBeanXXXXXX._$2Bean.ListBeanX item) {
