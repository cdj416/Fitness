...
public class MemberCardOrdersViewModel extends CustomViewModel {

    private AcitivityMemberCardOrdersBinding binding;
    ...
    public MemberCardOrdersViewModel(CustomActivity mActivity, AcitivityMemberCardOrdersBinding binding) {
        super(mActivity);
    ...
    protected void lazyLoad() {
        ...
        clearParams().setParams("o_type_code","o_card ");
