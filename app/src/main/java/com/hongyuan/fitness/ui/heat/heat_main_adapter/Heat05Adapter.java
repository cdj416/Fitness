...
public class Heat05Adapter extends BaseQuickAdapter<HeatBean.DataBean.ListBeanXXXXXX._$5Bean.ListBeanXXXX, BaseViewHolder> {

    public Heat05Adapter() {
        super(R.layout.item_heat_child);
    }

    @Override
    protected void convert(BaseViewHolder helper, HeatBean.DataBean.ListBeanXXXXXX._$5Bean.ListBeanXXXX item) {
