package com.hongyuan.fitness.custom_view.ruler_selector;
...
public class RulerView extends View {
    ...
    protected void init(Context context, AttributeSet attrs) {
        ...
        final TypedArray typedArray = context.obtainStyledAttributes(attrs,
                R.styleable.MyRulerView);

        mAlphaEnable = typedArray.getBoolean(R.styleable.MyRulerView_alphaEnable, mAlphaEnable);

        mLineSpaceWidth = typedArray.getDimension(R.styleable.MyRulerView_lineSpaceWidth, mLineSpaceWidth);
        mLineWidth = typedArray.getDimension(R.styleable.MyRulerView_lineWidth, mLineWidth);
        mLineMaxHeight = typedArray.getDimension(R.styleable.MyRulerView_lineMaxHeight, mLineMaxHeight);
        mLineMidHeight = typedArray.getDimension(R.styleable.MyRulerView_lineMidHeight, mLineMidHeight);
        mLineMinHeight = typedArray.getDimension(R.styleable.MyRulerView_lineMinHeight, mLineMinHeight);
        mLineColor = typedArray.getColor(R.styleable.MyRulerView_lineColor, mLineColor);

        mTextSize = typedArray.getDimension(R.styleable.MyRulerView_textSize,  mTextSize);
        mTextColor = typedArray.getColor(R.styleable.MyRulerView_textColor, mTextColor);
        mTextMarginTop = typedArray.getDimension(R.styleable.MyRulerView_textMarginTop, mTextMarginTop);

        mSelectorValue = typedArray.getFloat(R.styleable.MyRulerView_selectorValue, 0.0f);
        mMinValue = typedArray.getFloat(R.styleable.MyRulerView_rulMinValue, 0.0f);
        mMaxValue = typedArray.getFloat(R.styleable.MyRulerView_rulMaxValue, 100.0f);
        mPerValue = typedArray.getFloat(R.styleable.MyRulerView_perValue, 0.1f);
